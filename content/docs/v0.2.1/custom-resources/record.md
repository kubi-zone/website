...
The latest version of the `Record`'s Custom Resource Definition can be found [here](https://github.com/kubi-zone/kubizone-crds/blob/main/crds/kubi.zone/v1alpha1/Record.yaml)
